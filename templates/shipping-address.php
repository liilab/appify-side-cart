        ...
        <form class="woocommerce-shipping-calculator lii-ship-form" action="<?php echo esc_url(wc_get_cart_url()); ?>" method="post">
                ...
                <?php if (apply_filters('woocommerce_shipping_calculator_enable_state', true)) : ?>
                    <p class="form-row form-row-wide" id="calc_shipping_state_field">
                        ...
                        ?>
                            <span>
                                <select name="calc_shipping_state" class="state_select form-select form-select-sm lii-form-select example" id="calc_shipping_state" data-placeholder="<?php esc_attr_e('State / County', 'woocommerce'); ?>">
